...
post_detection_buffer_size = fps * 60  #Le puse un toque mas de tiempo despues de la deteccion porque me parecia poco si no
buffer_size = fps * 15 
...
while cap.isOpened(): #Mientras esté el video abirto e vn leyendo los frames
            ...
            if movement_detected:
                ...
                if color_percentage >= 10:
                    ...
                    if output_video is None:
                        ...
                        #Guardo los ultimos frames que tiene el buffer
    ...
    # Guardar los frames en el buffer
